...
public abstract class Transaction : AggregateRoot
{
    ...
    protected Transaction(Guid id, Guid houseHoldId, string description, decimal amount, DateTime date, TransactionType type, bool isPaid, string? category) : base(id)
    {
